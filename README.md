...
![Diagrama de arquitetura do projeto final DevOps](docs/20260513-HLD-ProjetoFinal-DevOps.drawio.png)
...
├── requirements.txt
├── docs/
│   ├── 20260513-HLD-ProjetoFinal-DevOps.drawio
│   └── 20260513-HLD-ProjetoFinal-DevOps.drawio.png
└── microservices/
    ├── service-a/
    │   ├── app.py
    │   ├── test_app.py
